...
export default class App extends Component {
 ...
 boxDataAdjust(box_info) {
  ...
  receivedData() {
      ...
      const token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6ImFubm90YXRvcl8xIiwidXNlcklkIjoiNjIxZGE3YmI1ODZhYzRlNmIxODBmZmRhIiwicm9sZSI6IkFubm90YXRvciIsImlhdCI6MTY1MTEyODYwNywiZXhwIjoxNjUxMjE1MDA3fQ.XZdByr1zOYL-ViW90Df6LTBJunWqtVnxl1dUURwoLMY'
